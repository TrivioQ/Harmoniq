...
Self-hosted enterprise deployments have two distinct operator roles — the *server operator* (DevOps/infra) and the *workspace admin* (product team lead). Currently:
